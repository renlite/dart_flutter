...
The superclass constructor `BindingBase(){...}` is called implicitly when the incstance of RenderingFlutterBinding is created. In the [BindingBase's constructor](https://github.com/flutter/flutter/blob/b22742018b/packages/flutter/lib/src/foundation/binding.dart#L45) there is especially the call `initInstances();` which invokes the overriden method in the [RendererBinding mixin](https://github.com/flutter/flutter/blob/b22742018b/packages/flutter/lib/src/rendering/binding.dart#L25). RenderingFlutterBinding uses amongst others the RendererBinding mixin.
